...
[Remote Data Blocks](https://github.com/Automattic/remote-data-blocks) is a WordPress plugin that makes it easy to combine content and remote data in the block editor. Easily register blocks that load data from Airtable, Google Sheets, Shopify, GitHub, or any other API. [Read more about well-supported use cases](https://github.com/Automattic/remote-data-blocks).
...
* [E-commerce](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/automattic/remote-data-blocks-demo/trunk/shopify/shopify-blueprint.json) - Use a Shopify connection to reference content and build individual product pages.
