	...
	$driver_by_id_query = HttpQuery::from_array([
		...
		'output_schema' => [
			...
			'type' => [
				...
				'nationality' => [
					'name' => 'Nationality',
					'path' => '$.response[0].nationality',
					'type' => 'string',
				],
				'birthdate' => [
					'name' => 'Birthdate',
					'path' => '$.response[0].birthdate',
					'type' => 'string',
				],
				'birthplace' => [
					'name' => 'Birthplace',
					'path' => '$.response[0].birthplace',
					'type' => 'string',
				],
				'world_championships' => [
					'name' => 'World Championships',
					'path' => '$.response[0].world_championships',
					'type' => 'integer',
				],
				'podiums' => [
					'name' => 'Podiums',
					'path' => '$.response[0].podiums',
					'type' => 'integer',
				],
				'career_points' => [
					'name' => 'Career Points',
					'path' => '$.response[0].career_points',
					'type' => 'integer',
				],
				'current_team_name' => [
					'name' => 'Current Team',
					'path' => '$.response[0].teams[0].team.name',
					'type' => 'string',
				],
				'current_team_logo' => [
					'name' => 'Current Team Logo',
					'path' => '$.response[0].teams[0].team.logo',
					'type' => 'image_url',
				],
				'current_team_logo_alt' => [
					'name' => 'Team Logo Alt Text',
					'path' => '$.response[0].teams[0].team.name',
					'type' => 'image_alt',
				],
				'team_name_linked' => [
	...
	$team_by_id_query = HttpQuery::from_array([
		...
		'output_schema' => [
			...
			'type' => [
				...
				'base' => [
					'name' => 'Location',
					'path' => '$.response[0].base',
					'type' => 'string',
				],
				'first_team_entry' => [
					'name' => 'First Year in F1',
					'path' => '$.response[0].first_team_entry',
					'type' => 'integer',
				],
				'world_championships' => [
					'name' => 'World Championships',
				...
				'president' => [
					'name' => 'President',
					'path' => '$.response[0].president',
					'type' => 'string',
				],
				'director' => [
					'name' => 'Director',
					'path' => '$.response[0].director',
					'type' => 'string',
				],
				'technical_manager' => [
					'name' => 'Technical Manager',
					'path' => '$.response[0].technical_manager',
					'type' => 'string',
				],
				'engine_supplier' => [
					'name' => 'Engine Supplier',
					'path' => '$.response[0].engine',
					'type' => 'string',
				],
				'chassis' => [
					'name' => 'Chassis',
					'path' => '$.response[0].chassis',
					'type' => 'string',
				],
				'tyres' => [
					'name' => 'Tyres',
					'path' => '$.response[0].tyres',
					'type' => 'string',
				],
			],
		],
